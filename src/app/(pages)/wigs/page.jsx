    ...
    <div className="">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="w-full aspect-square">
          <Image src={wig_one} width={1000} height={1000} alt='wigs'/>
          <div className='py-2'>
        ...
        <div className="w-full aspect-square">
          <Image src={wig_two} width={1000} height={1000} alt='wigs'/>
          <div className='py-2'>
        ...
        <div className="w-full aspect-square">
          <Image src={wig_three} width={1000} height={1000} alt='wigs'/>
          <div className='py-2'>
        ...
        <div className="w-full aspect-square">
          <Image src={wig_four} width={1000} height={1000} alt='wigs'/>
          <div className='py-2'>
        ...
        <div className="w-full aspect-square">
          <Image src={wig_five} width={1000} height={1000} alt='wigs'/>
          <div className='py-2'>
        ...
        <div className="w-full aspect-square">
          <Image src={wig_six} width={1000} height={1000} alt='wigs'/>
          <div className='py-2'>
