...
const AboutUs = () => {
  return (
    <section className='md:py-14'>
        <div className='flex items-center flex-wrap lg:flex-row flex-col gap-10 md:gap-36 min-h-screen'>
            <div className="border-2 flex-1 w-full aspect-square bg-black"></div>
            <div className="border-2 flex-1 w-full aspect-square bg-black"></div>
        </div>

        <div className='text-center my-10 lg:my-32 font-medium text-sm md:text-lg lg:leading-9'>
        ...
        <div className='flex gap-10 items-center md:flex-row flex-col my-10 md:my-10'>
            ...
            <div className='flex-1'>
                ...
                <p className=' font-medium md:font-semibold text-sm md:texl-lg'><span className={vollkorn.className}><span className='font-black'>Evodie Ngoy</span> has worked in the hair and makeup space for 9 years. She has experience styling hair for all types of occasions and makeup application from birthday makeup to bridal makeup. As the Founder and CEO of Evatouch Beauty, her mission is to ensure that all race, age and gender all over the world no matter the skin type and undertones can enjoy affordable luxury by providing innovative and quality products to cater to all beauty needs locally and across the border</span></p>
            </div>
        </div>
    </section>
  )
